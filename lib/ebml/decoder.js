...
EbmlDecoder.prototype.readTag = function() {
    ...
    var tagId   = tools.getVintValue(this._buffer, tagLength, this._cursor)
    var tagStr  = this._buffer.toString('hex', this._cursor, this._cursor + tagLength)
...
EbmlDecoder.prototype.readSize = function() {
    ...
    var dataSize  = tools.getVintValue(this._buffer, sizeLength, this._cursor)
