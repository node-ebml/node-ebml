...
function EbmlDecoder(options) {
    ...
    this._total        = 0
    this._schema       = schema
    this._emitTags     = options.emitTags || '*'
    this._emitEndTags  = options.emitEndTags || false
}
...
EbmlDecoder.prototype.shouldEmit = function(el) {
    return this._emitTags == '*' || this._emitTags.contains(el.name)
}
...
EbmlDecoder.prototype.readContent = function() {
    ...
    while(this._tag_stack.length > 0) {
        ...
        if ( this.shouldEmit(topEle) && this._emitEndTags ) {
